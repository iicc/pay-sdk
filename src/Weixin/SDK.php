<?php
namespace Iiccn\PaySDK\Weixin;

use \Iiccn\PaySDK\Base;
use Iiccn\PaySDK\Lib\XML;
use Iiccn\PaySDK\Lib\ObjectToArray;
use Iiccn\PaySDK\Weixin\Report\Request;
use Iiccn\PaySDK\Weixin\Params\PublicParams;
...
class SDK extends Base
{
	/**
	 * 公共参数
	 * @var \Iiccn\PaySDK\Weixin\Params\PublicParams
	 */
	public $publicParams;

	/**
	 * 用于上报的SDK实例
	 * @var \Iiccn\PaySDK\Weixin\SDK
	 */
	public $reportSDK;
