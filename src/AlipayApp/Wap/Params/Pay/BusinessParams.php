<?php
namespace Iiccn\PaySDK\AlipayApp\Wap\Params\Pay;

use \Iiccn\PaySDK\AlipayApp\Wap\Params\Pay\ExtendParams;
...
class BusinessParams
{
	...
	/**
	 * 业务扩展参数，详见业务扩展参数说明
	 * @var \Iiccn\PaySDK\AlipayApp\Wap\Params\Pay\ExtendParams
	 */
