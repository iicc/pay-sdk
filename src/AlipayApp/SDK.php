<?php
namespace Iiccn\PaySDK\AlipayApp;
...
class SDK extends Base
{
	/**
	 * 公共参数
	 * @var \Iiccn\PaySDK\AlipayApp\Params\PublicParams
	 */
	public $publicParams;
	...
	public function verifyCallback($data)
	{
		...
		switch($signType)
		{
			...
			case 'RSA2':
				return \Iiccn\PaySDK\Lib\Encrypt\RSA2::$method($content, $key, \base64_decode($data['sign']));
			default:
