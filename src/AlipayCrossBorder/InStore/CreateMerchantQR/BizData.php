<?php
namespace Iiccn\PaySDK\AlipayCrossBorder\InStore\CreateMerchantQR;
...
class BizData
{
	 ...
	 * @var \Iiccn\PaySDK\AlipayCrossBorder\InStore\CreateMerchantQR\ChannelFee
	 */
	public $channel_fee;
	 ...
	 * @var string
	 */
	public $passback_parameters = array();
	...
	{
		$this->channel_fee = new \Iiccn\PaySDK\AlipayCrossBorder\InStore\CreateMerchantQR\ChannelFee;
	}
