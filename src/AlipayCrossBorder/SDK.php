<?php
namespace Iiccn\PaySDK\AlipayCrossBorder;

use \Iiccn\PaySDK\Base;
...
class SDK extends Base
{
	/**
	 * 公共参数
	 * @var \Iiccn\PaySDK\AlipayCrossBorder\Params\PublicParams
	 */
	public $publicParams;
	...
	public function sign($data)
	{
		...
		{
			case 'DSA':
				$result = \Iiccn\PaySDK\Lib\Encrypt\DSA::$method($content, $key);
				break;
			case 'RSA':
				$result = \Iiccn\PaySDK\Lib\Encrypt\RSA::$method($content, $key);
				break;
			case 'RSA2':
				$result = \Iiccn\PaySDK\Lib\Encrypt\RSA2::$method($content, $key);
				break;
			case 'MD5':
	...
	public function verifyCallback($data)
	{
		...
		{
			case 'DSA':
				return \Iiccn\PaySDK\Lib\Encrypt\DSA::$method($content, $key, \base64_decode($data['sign']));
			case 'RSA':
				return \Iiccn\PaySDK\Lib\Encrypt\RSA::$method($content, $key, \base64_decode($data['sign']));
			case 'MD5':
